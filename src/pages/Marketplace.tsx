...
const mockNFTs: NFTItem[] = [
  ...
  },
  {
    ...
    currency: "VYB",
    image:
      "https://www.howtoconcerts.com/wp-content/uploads/2023/08/How-To-Make-an-Access-Pass-Blog.jpg",
    isAuction: false,
    likes: 120,
    category: "utility",
    tokenId: "0x9876...5432",
  ...
  },
  {
    ...
    currency: "VYB",
    image:
      "https://images.unsplash.com/photo-1545231027-637d2f6210f8?auto=format&fit=crop&w=800&q=80",
    isAuction: false,
    likes: 89,
    category: "art",
    tokenId: "0x2345...6789",
...
const NFTCard: React.FC<{ nft: NFTItem }> = ({ nft }) => {
  return (
    <div className="glass-card overflow-hidden hover-scale transition-all duration-300">
      ...
      <div className="p-4">
        <h3 className="font-orbitron text-lg font-medium mb-1 truncate">
          {nft.name}
        </h3>
    ...
    <Layout>
      <div className="py-4">
        <div className="glass-card p-6 mb-6">
          <h1 className="text-2xl font-orbitron font-bold mb-2 text-glow">
            NFT Marketplace
          </h1>
        ...
        <Tabs defaultValue="all">
          ...
          <TabsContent value="utility" className="mt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {mockNFTs
                .filter((nft) => nft.category === "utility")
                .map((nft) => (
                  <NFTCard key={nft.id} nft={nft} />
                ))}
            </div>
